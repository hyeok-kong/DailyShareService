...
import com.bong.DailyShareService.domain.Token;
...
public class TokenService {
    ...
    public Token generateToken(String uid, String role) {
        ...
        long refrechPeriod = 1000L * 60L * 60L * 24L * 30L * 3L; // 리프레쉬 토큰의 만료시간, 3주
        ...
        return new Token(
                ...
                Jwts.builder()
                        .setClaims(claims)
                        .setIssuedAt(now)
                        .setExpiration(new Date(now.getTime() + refrechPeriod))
                        .signWith(SignatureAlgorithm.HS256, secretKey)
                        .compact());
    }
